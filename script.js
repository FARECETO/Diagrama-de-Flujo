...
// ⚠️ PEGA AQUÍ TU API KEY COPIADA DE GOOGLE AI STUDIO
const GEMINI_API_KEY = "AIzaSyCpEV6XnJQTu5GHzzCSfCnxZaGOCFf_dcU";
...
document.getElementById("convertTextBtn").addEventListener("click", async () => {
  ...
  if (GEMINI_API_KEY === "TU_API_KEY_AQUÍ") {
    alert("Por favor, introduce una API Key válida de Google AI Studio en el script.js");
    return;
  }

  // Animación de carga profesional en el botón
